...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT DecodeConfigDefaultTypeInternal _DecodeConfig_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_wenet_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::wenet::DecodeConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::wenet::DecodeConfig, nbest_config_),
  PROTOBUF_FIELD_OFFSET(::wenet::DecodeConfig, continuous_decoding_config_),
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::wenet::_DecodeConfig_default_instance_),
...
const char descriptor_table_protodef_wenet_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013wenet.proto\022\005wenet\"H\n\014DecodeConfig\022\024\n\014"
  "nbest_config\030\001 \001(\005\022\"\n\032continuous_decodin"
  "g_config\030\002 \001(\010\"_\n\007Request\022,\n\rdecode_conf"
  "ig\030\001 \001(\0132\023.wenet.DecodeConfigH\000\022\024\n\naudio"
  "_data\030\002 \001(\014H\000B\020\n\016RequestPayload\"\355\002\n\010Resp"
  "onse\022&\n\006status\030\001 \001(\0162\026.wenet.Response.St"
  "atus\022\"\n\004type\030\002 \001(\0162\024.wenet.Response.Type"
  "\022&\n\005nbest\030\003 \003(\0132\027.wenet.Response.OneBest"
  "\032I\n\007OneBest\022\020\n\010sentence\030\001 \001(\t\022,\n\nwordpie"
  "ces\030\002 \003(\0132\030.wenet.Response.OnePiece\0324\n\010O"
  "nePiece\022\014\n\004word\030\001 \001(\t\022\r\n\005start\030\002 \001(\005\022\013\n\003"
  "end\030\003 \001(\005\"\034\n\006Status\022\006\n\002ok\020\000\022\n\n\006failed\020\001\""
  "N\n\004Type\022\020\n\014server_ready\020\000\022\022\n\016partial_res"
  "ult\020\001\022\020\n\014final_result\020\002\022\016\n\nspeech_end\020\0032"
  "9\n\003ASR\0222\n\tRecognize\022\016.wenet.Request\032\017.we"
  "net.Response\"\000(\0010\001B\021\n\007ex.grpc\242\002\005wenetb\006p"
  "roto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_wenet_2eproto = {
  false, false, 645, descriptor_table_protodef_wenet_2eproto, "wenet.proto", 
...
DecodeConfig::DecodeConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:wenet.DecodeConfig)
}
DecodeConfig::DecodeConfig(const DecodeConfig& from)
  ...
  // @@protoc_insertion_point(copy_constructor:wenet.DecodeConfig)
}

void DecodeConfig::SharedCtor() {
...
DecodeConfig::~DecodeConfig() {
  // @@protoc_insertion_point(destructor:wenet.DecodeConfig)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void DecodeConfig::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void DecodeConfig::ArenaDtor(void* object) {
  DecodeConfig* _this = reinterpret_cast< DecodeConfig* >(object);
  (void)_this;
}
void DecodeConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:wenet.DecodeConfig)
...
const char* DecodeConfig::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
::PROTOBUF_NAMESPACE_ID::uint8* DecodeConfig::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:wenet.DecodeConfig)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:wenet.DecodeConfig)
  return target;
}

size_t DecodeConfig::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:wenet.DecodeConfig)
  size_t total_size = 0;
...
void DecodeConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:wenet.DecodeConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const DecodeConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<DecodeConfig>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:wenet.DecodeConfig)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:wenet.DecodeConfig)
    MergeFrom(*source);
  }
}

void DecodeConfig::MergeFrom(const DecodeConfig& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:wenet.DecodeConfig)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void DecodeConfig::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:wenet.DecodeConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:wenet.DecodeConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void DecodeConfig::InternalSwap(DecodeConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DecodeConfig, continuous_decoding_config_)
      + sizeof(DecodeConfig::continuous_decoding_config_)
      - PROTOBUF_FIELD_OFFSET(DecodeConfig, nbest_config_)>(
...
class Request::_Internal {
 public:
  static const ::wenet::DecodeConfig& decode_config(const Request* msg);
};

const ::wenet::DecodeConfig&
Request::_Internal::decode_config(const Request* msg) {
  return *msg->RequestPayload_.decode_config_;
}
void Request::set_allocated_decode_config(::wenet::DecodeConfig* decode_config) {
...
Request::Request(const Request& from)
  ...
  switch (from.RequestPayload_case()) {
    case kDecodeConfig: {
      _internal_mutable_decode_config()->::wenet::DecodeConfig::MergeFrom(from._internal_decode_config());
      break;
    }
    case kAudioData: {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // .wenet.DecodeConfig decode_config = 1;
      case 1:
...
template<> PROTOBUF_NOINLINE ::wenet::DecodeConfig* Arena::CreateMaybeMessage< ::wenet::DecodeConfig >(Arena* arena) {
  return Arena::CreateMessageInternal< ::wenet::DecodeConfig >(arena);
}
