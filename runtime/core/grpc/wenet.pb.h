...
PROTOBUF_NAMESPACE_OPEN
template<> ::wenet::DecodeConfig* Arena::CreateMaybeMessage<::wenet::DecodeConfig>(Arena*);
...
class DecodeConfig PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wenet.DecodeConfig) */ {
 public:
  inline DecodeConfig() : DecodeConfig(nullptr) {}
  virtual ~DecodeConfig();
  explicit constexpr DecodeConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline DecodeConfig* New() const final {
    return CreateMaybeMessage<DecodeConfig>(nullptr);
  }

  DecodeConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  // @@protoc_insertion_point(class_scope:wenet.DecodeConfig)
 private:
  class _Internal;
...
class Request PROTOBUF_FINAL :
 ...
 public:
  ...
  const ::wenet::DecodeConfig& decode_config() const;
  ::wenet::DecodeConfig* release_decode_config();
  ::wenet::DecodeConfig* mutable_decode_config();
  void set_allocated_decode_config(::wenet::DecodeConfig* decode_config);
  private:
  const ::wenet::DecodeConfig& _internal_decode_config() const;
  ::wenet::DecodeConfig* _internal_mutable_decode_config();
  public:
  void unsafe_arena_set_allocated_decode_config(
      ::wenet::DecodeConfig* decode_config);
  ::wenet::DecodeConfig* unsafe_arena_release_decode_config();
 ...
 private:
  ...
  union RequestPayloadUnion {
    ...
    ::wenet::DecodeConfig* decode_config_;
...
// int32 nbest_config = 1;
inline void DecodeConfig::clear_nbest_config() {
  nbest_config_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 DecodeConfig::_internal_nbest_config() const {
  return nbest_config_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 DecodeConfig::nbest_config() const {
  // @@protoc_insertion_point(field_get:wenet.DecodeConfig.nbest_config)
  return _internal_nbest_config();
}
inline void DecodeConfig::_internal_set_nbest_config(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  nbest_config_ = value;
}
inline void DecodeConfig::set_nbest_config(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_nbest_config(value);
  // @@protoc_insertion_point(field_set:wenet.DecodeConfig.nbest_config)
}

// bool continuous_decoding_config = 2;
inline void DecodeConfig::clear_continuous_decoding_config() {
  continuous_decoding_config_ = false;
}
inline bool DecodeConfig::_internal_continuous_decoding_config() const {
  return continuous_decoding_config_;
}
inline bool DecodeConfig::continuous_decoding_config() const {
  // @@protoc_insertion_point(field_get:wenet.DecodeConfig.continuous_decoding_config)
  return _internal_continuous_decoding_config();
}
inline void DecodeConfig::_internal_set_continuous_decoding_config(bool value) {
  
  continuous_decoding_config_ = value;
}
inline void DecodeConfig::set_continuous_decoding_config(bool value) {
  _internal_set_continuous_decoding_config(value);
  // @@protoc_insertion_point(field_set:wenet.DecodeConfig.continuous_decoding_config)
}
...
inline ::wenet::DecodeConfig* Request::release_decode_config() {
  // @@protoc_insertion_point(field_release:wenet.Request.decode_config)
  if (_internal_has_decode_config()) {
    clear_has_RequestPayload();
      ::wenet::DecodeConfig* temp = RequestPayload_.decode_config_;
    if (GetArena() != nullptr) {
...
inline const ::wenet::DecodeConfig& Request::_internal_decode_config() const {
  return _internal_has_decode_config()
      ? *RequestPayload_.decode_config_
      : reinterpret_cast< ::wenet::DecodeConfig&>(::wenet::_DecodeConfig_default_instance_);
}
inline const ::wenet::DecodeConfig& Request::decode_config() const {
  // @@protoc_insertion_point(field_get:wenet.Request.decode_config)
  return _internal_decode_config();
}
inline ::wenet::DecodeConfig* Request::unsafe_arena_release_decode_config() {
...
inline void Request::unsafe_arena_set_allocated_decode_config(::wenet::DecodeConfig* decode_config) {
...
inline ::wenet::DecodeConfig* Request::_internal_mutable_decode_config() {
  if (!_internal_has_decode_config()) {
    clear_RequestPayload();
    set_has_decode_config();
    RequestPayload_.decode_config_ = CreateMaybeMessage< ::wenet::DecodeConfig >(GetArena());
  }
  return RequestPayload_.decode_config_;
}
inline ::wenet::DecodeConfig* Request::mutable_decode_config() {
