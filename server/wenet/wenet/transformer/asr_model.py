...
class ASRModel(torch.nn.Module):
    ...
    def _ctc_prefix_beam_search(
        ...
        num_decoding_left_chunks: int = -1,
        simulate_streaming: bool = False,
    ) -> Tuple[List[Tuple[tuple, float]], torch.Tensor, torch.Tensor]:
        ...
        for t in range(0, maxlen):
            ...
            print("[top_k_logp] {}".format(top_k_logp))
            print("[top_k_index] {}".format(top_k_index))
    ...
    def ctc_prefix_beam_search(
        ...
        """
        hyps, _, _ = self._ctc_prefix_beam_search(speech, speech_lengths,
    ...
    def attention_rescoring(
        ...
        hyps, encoder_out, ctc_probs = self._ctc_prefix_beam_search(
        ...
        print("[hyps] {}".format(hyps))
        return hyps[best_index][0], ctc_probs
